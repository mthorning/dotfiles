return {
  ...
  config = function()
    ...
    wk.add({
      ...
      { '<leader>gl', '<cmd>lua Snacks.lazygit()<CR>', desc = 'LazyGit', nowait = false, remap = false },
      { '<leader>gb', '<cmd>lua Snacks.git.blame_line()<CR>', desc = 'Blame', nowait = false, remap = false },
      { '<leader>go', '<cmd>lua Snacks.gitbrowse()<CR>', desc = 'Open repo', nowait = false, remap = false },
      ...
      { '<leader>tv', '<cmd>vsplit | :lua Snacks.terminal.open()<CR>', desc = 'Vert split', nowait = false, remap = false },
