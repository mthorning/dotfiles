return {
  ...
  config = function()
    ...
    wk.add({
      ...
      { '<leader>A',       '<CMD>AiderCurrentFile<CR>',                                                               desc = 'Open Aider with current file', nowait = false,    remap = false },
      ...
      { '<leader>ld',      '<CMD>call CocAction("jumpDefinition", "edit")<CR>',                                        desc = 'Goto Definition',              nowait = false,    remap = false },
      { '<leader>lf',      '<CMD>call CocAction("jumpReferences")<CR>',                                               desc = 'References',                   nowait = false,    remap = false },
      { '<leader>lh',      '<CMD>call CocActionAsync("doHover")<CR>',                                                 desc = 'Hover',                        nowait = false,    remap = false },
      { '<leader>ll',      '<CMD>call CocAction("diagnosticShow")<CR>',                                               desc = 'Line Diagnostic',              nowait = false,    remap = false },
      ...
      { '<leader>lt',      '<CMD>call CocAction("jumpTypeDefinition")<CR>',                                            desc = 'Goto Type Definition',         nowait = false,    remap = false },
      { '<leader>lv',      '<CMD>call CocAction("jumpDefinition", "vsplit")<CR>',                                     desc = 'Goto Definition in split',     nowait = false,    remap = false },
