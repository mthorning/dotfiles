...
_G.packer_plugins = {
  ...
  ["vim-repeat"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/vim-repeat",
  ...
  ["vim-surround"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/vim-surround",
