...
_G.packer_plugins = {
  ...
  ["galaxyline.nvim"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/galaxyline.nvim",
  ...
  neomux = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/neomux",
  ...
  ["nvim-bqf"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/nvim-bqf",
  ...
  ["nvim-treesitter-textobjects"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/nvim-treesitter-textobjects",
  ...
  ["vim-localvimrc"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/vim-localvimrc",
  ...
  ["which-key.nvim"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/which-key.nvim",
