...
_G.packer_plugins = {
  ...
  fzf = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/fzf",
  ...
  ["telescope-fzf-native.nvim"] = {
    loaded = true,
    path = "/Users/matthewthorning/.local/share/nvim/site/pack/packer/start/telescope-fzf-native.nvim",
